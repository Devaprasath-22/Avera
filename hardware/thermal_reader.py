"""
MLX90614 Non contact IR Themometer sensor Reader for MedGemma Medical Kiosk.
Reads MLX90614 Non contact IR Themometer sensor via I2C.
    ...
    def __init__(self, use_hardware: bool = True, i2c_address: int = 0x5A, i2c_bus: int = 1):
        ...
        if use_hardware:
            try:
                ...
                print(f"[Thermal] Live MLX90614 Non contact IR Themometer sensor connected at address 0x{i2c_address:X}")
